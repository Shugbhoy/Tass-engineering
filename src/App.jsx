...
function PathwaysModule(){
  const pathways=[
    {id:"mechanical",icon:"⚙️",name:"Mechanical Engineering",
     ...
     entry:"National 5 Maths and Physics or Engineering Science are preferred by main employers. Mechanical aptitude and genuine enthusiasm essential. Age 16+.",
    ...
    {id:"electrical",icon:"⚡",name:"Electrical Engineering",
     ...
     entry:"National 5 Maths and Physics preferred. Some employers (SSE, ScottishPower) ask for National 5 Maths at grade C or above. Age 16+.",
    ...
    {id:"civil",icon:"🏗️",name:"Civil Engineering",
     ...
     entry:"National 5 Maths preferred. Some employers also ask for National 5 English. Physically active role — outdoor site work in all weathers. Age 16+.",
    ...
    {id:"instrumentation",icon:"📡",name:"Instrumentation and Control",
     ...
     entry:"National 5 Maths and Physics or Engineering Science preferred. An interest in both mechanical and electrical systems is a strength. Age 16+.",
    ...
    {id:"oilgas",icon:"🛢️",name:"Oil, Gas and Petrochemical",
     ...
     entry:"National 5 Maths preferred. Many employers set a minimum age of 18 due to offshore safety requirements. OPITO offshore survival training provided by employer.",
    ...
    {id:"renewables",icon:"🌊",name:"Renewable Energy",
     ...
     entry:"National 5 Maths preferred. Must be comfortable working at height and offshore — GWO (Global Wind Organisation) safety training provided by employer. Minimum age often 18.",
    ...
    {id:"aerospace",icon:"✈️",name:"Aerospace and Defence",
     ...
     entry:"National 5 Maths and Engineering Science or Physics preferred. Spirit AeroSystems and Leonardo typically ask for Maths at National 5 minimum. Strong attention to detail essential. Age 16+.",
    ...
    {id:"manufacturing",icon:"🏭",name:"Manufacturing and Production",
     ...
     entry:"National 5 Maths preferred. Good spatial awareness and manual dexterity are important. Age 16+.",
    ...
    {id:"chemical",icon:"⚗️",name:"Chemical and Process Engineering",
     ...
     entry:"National 5 Maths and a science subject (Chemistry, Biology or Physics) preferred. Age 16+.",
    ...
    {id:"structural",icon:"🏢",name:"Structural and Building Services",
     ...
     entry:"National 5 Maths preferred. Building services roles often suit candidates with an interest in both engineering and construction. Age 16+.",
