...
function PathwaysModule(){
  const pathways=[
    {id:"mechanical",icon:"⚙️",name:"Mechanical Engineering",
     ...
     entry:"No formal academic entry requirements. National 5 Maths and Physics or Engineering Science are preferred by main employers. Mechanical aptitude and genuine enthusiasm essential. Age 16+.,
    ...
    {id:"electrical",icon:"⚡",name:"Electrical Engineering",
     ...
     entry:"No formal academic entry requirements. National 5 Maths and Physics preferred. Some employers (SSE, ScottishPower) ask for National 5 Maths at grade C or above. Age 16+.,
    ...
    {id:"civil",icon:"🏗️",name:"Civil Engineering",
     ...
     entry:"No formal academic entry requirements. National 5 Maths preferred. Some employers ask for National 5 English. Physically active role — outdoor site work in all weathers. Age 16+.,
    ...
    {id:"instrumentation",icon:"📡",name:"Instrumentation and Control",
     ...
     entry:"No formal academic entry requirements. National 5 Maths and Physics or Engineering Science preferred. An interest in both mechanical and electrical systems is a strength. Age 16+.,
    ...
    {id:"oilgas",icon:"🛢️",name:"Oil, Gas and Petrochemical",
     ...
     entry:"No formal academic entry requirements. National 5 Maths preferred. Many employers set a minimum age of 18 due to offshore safety requirements. OPITO offshore survival training provided by employer.,
    ...
    {id:"renewables",icon:"🌊",name:"Renewable Energy",
     ...
     entry:"No formal academic entry requirements. National 5 Maths preferred. Must be comfortable working at height and offshore — GWO (Global Wind Organisation) safety training provided by employer. Minimum age often 18.,
    ...
    {id:"aerospace",icon:"✈️",name:"Aerospace and Defence",
     ...
     entry:"No formal academic entry requirements. National 5 Maths and Engineering Science or Physics preferred. Spirit AeroSystems and Leonardo typically ask for Maths at National 5 minimum. Strong attention to detail essential. Age 16+.,
    ...
    {id:"manufacturing",icon:"🏭",name:"Manufacturing and Production",
     ...
     entry:"No formal academic entry requirements. National 5 Maths preferred. Good spatial awareness and manual dexterity are important. Age 16+.,
    ...
    {id:"chemical",icon:"⚗️",name:"Chemical and Process Engineering",
     ...
     entry:"No formal academic entry requirements. National 5 Maths and a science subject (Chemistry, Biology or Physics) preferred. Age 16+.,
    ...
    {id:"structural",icon:"🏢",name:"Structural and Building Services",
     ...
     entry:"No formal academic entry requirements. National 5 Maths preferred. Building services roles often suit candidates with an interest in both engineering and construction. Age 16+.,
  ...
  return (
    <div>
      ...
      <Card>
        ...
        {[["Typical roles",p.roles],["Entry requirements",p.entry],["Key qualifications",p.quals],["Scottish employers",p.employers]].map(([label,val],i)=>(
...
function CVModule(){
  ...
  const cvs={
    ...
    graduate:{label:"College or Work Experience (18–22)",
      profile:{
        weak:"I have done some engineering at college and I have also worked in a practical environment. I enjoy hands-on work and I think an engineering apprenticeship would suit me well.",
        strong:"18-year-old with National Certificate Engineering (Mechanical) from Fife College and 12 months of part-time workshop experience at a local fabrication company. Gained practical experience in MIG welding, angle grinding and basic fitting under the supervision of qualified welders. Completed IOSH Working Safely (2024) and manual handling certificate. Familiar with basic engineering drawing conventions and use of hand and power tools. Seeking a Mechanical Engineering Apprenticeship with SSE — specifically motivated by SSE's commitment to renewables and their structured apprenticeship programme that develops technicians across Scotland's energy infrastructure."},
      experience:{
        weak:"I have done some college work and I have also done a bit of practical work. I helped out at a local garage and I have used tools at home. I enjoy practical work and I learn quickly.",
        strong:"Part-time Workshop Assistant, Forth Fabrications — Kirkcaldy (Sept 2023–present)\n• Assisted qualified welders and fabricators on light structural steelwork for commercial clients\n• Responsible for material preparation — measuring, marking out and cutting steel sections to specification\n• Operated angle grinder, bench grinder and drill press under supervision following safety induction\n• Maintained a clean and organised workshop — tool accountability, waste removal, 5S standards\n• Received written reference from the workshop manager describing me as reliable, safety-conscious and technically capable\n\nNational Certificate Engineering (Mechanical), Fife College (2023–2024)\n• Completed modules in Engineering Principles, Technical Drawing and Workshop Practice\n• Achieved B grade in Workshop Practice module — assessed on lathe operation and bench fitting\n• IOSH Working Safely certificate completed as part of the programme"}},
